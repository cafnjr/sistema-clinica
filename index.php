...
<?php 
	if(isset($_POST['recuperar-senha'])){
		...
		if($linhas > 0){
			...
			echo "<script language='javascript'>window.alert('Email não cadastrado no sistema !!'); </script> ";
		}
	}

	// AQUI VAI O CÓDIGO DO ENVIO DO EMAIL
	/*
	$to = $email_usuario;
			$subject = 'Recuperação de Senha ClinMed';
